...
Please work in teams of 4 students.
...
The deadline is 31 December 2024, 11.59 PM.
...
4.  Load in the dataset `london_marathon.csv` on London Marathons as `london_marathon` using the package `here`.
5.  Get to know the dataset.
6.  Read in the dataset `winnners.csv` and merge it with `london_marathon`.
7.  Visualize 4 interesting relationships between variables in the resulting dataset.
