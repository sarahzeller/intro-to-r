...
We install packages, which contain functions.
We install them once (in the console).
...
-   Download this repository: [https://github.com/sarahzeller/intro-to-r](https://github.com/sarahzeller/intro-to-r)
-   *unzip*/*extract* it and save it somewhere
-   double-click on the `.Rproj`
-   open *01-Introduction/01-Quarto-Exercises.qmd*
